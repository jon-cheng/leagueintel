...
st.info(
    ...
    "those same weeks. PPG columns are shown "
    "separately for readability, but the score itself is computed on "
    "totals.\n"
    "- **Comparison Field plot**: click a player's “Plot Comparison” "
    "checkbox to see the full comparison population — a violin (shape + "
    "median/IQR) with every comparison player's total plotted as a dot, "
    "this pickup highlighted in red. Hover for each player's own "
    "points-per-game.\n"
